...
class OrderItem(db.Model):
    ...
    original_price = db.Column(db.Numeric(10, 2), nullable=False, default=0.00) # New Column
    discount_required = db.Column(db.Boolean, default=False) #New Column
    sales_volume = db.Column(db.Integer, default=0) #New Column
    discount_last_week = db.Column(db.Numeric(10, 2), default=0.00) #New Column
    lag_sales = db.Column(db.Integer, default=0) #New Column
